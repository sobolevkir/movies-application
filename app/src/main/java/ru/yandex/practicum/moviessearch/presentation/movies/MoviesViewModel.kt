...
class MoviesViewModel(
    private val context: Context, private val moviesInteractor: MoviesInteractor
) : ViewModel() {
    ...
    private fun processResult(foundMovies: List<Movie>?, errorMessage: String?) {
        ...
        when {
            ...
            movies.isEmpty() -> renderState(MoviesState.Empty(context.getString(R.string.nothing_found)))
